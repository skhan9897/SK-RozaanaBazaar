...
<header class="main-header">
    <div class="container-premium d-flex align-items-center w-100">
        ...
        <button class="btn d-md-none text-white p-0 mr-3" type="button" aria-label="Menu">
        ...
        <div class="search-container d-none d-md-flex flex-grow-1">
            <form action="search" method="GET" class="w-100 d-flex align-items-center">
                <input type="text" name="q" placeholder="Search for products, brands and more" aria-label="Search" value="${searchQuery}">
        ...
        <div class="header-links d-flex align-items-center">
            <c:choose>
                <c:when test="${not empty user}">
                    <div class="dropdown">
                        <a class="dropdown-toggle font-weight-bold d-flex align-items-center" href="#" id="userMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="text-decoration: none;">
                            <span class="d-none d-lg-inline">${user.name}</span>
                            <i class="fas fa-user-circle d-lg-none" style="font-size: 20px;"></i>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right shadow-sm border-0" aria-labelledby="userMenu" style="border-radius: 2px; margin-top: 10px;">
                            <div class="dropdown-header d-lg-none">${user.name}</div>
                ...
                <c:otherwise>
                    <a href="login.jsp" class="btn btn-light text-primary font-weight-bold px-4 py-1 d-none d-md-block" style="border-radius: 2px; text-transform: none; height: 32px; padding: 0 20px !important;">Login</a>
                    <a href="login.jsp" class="text-white d-md-none mr-3" style="font-size: 20px;"><i class="fas fa-user"></i></a>
                </c:otherwise>
            </c:choose>

            <a href="admin/login.jsp" class="d-none d-lg-block font-weight-bold ml-4" style="text-decoration: none;">Become a Seller</a>

            <div class="dropdown ml-4 d-none d-lg-block">
                <a class="dropdown-toggle font-weight-bold" href="#" id="moreMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="text-decoration: none;">
                    More
                </a>
                <div class="dropdown-menu dropdown-menu-right shadow-sm border-0" aria-labelledby="moreMenu" style="border-radius: 2px; margin-top: 10px;">
            ...
            <a href="cart.jsp" class="font-weight-bold ml-4 position-relative d-flex align-items-center" style="text-decoration: none;">
    ...
    <div class="container-premium d-md-none w-100 pb-2">
        <div class="search-container m-0" style="max-width: 100%;">
            <form action="search" method="GET" class="w-100 d-flex align-items-center">
                <input type="text" name="q" placeholder="Search for products" aria-label="Search" value="${searchQuery}">
                <button type="submit"><i class="fas fa-search"></i></button>
            </form>
        </div>
    </div>
